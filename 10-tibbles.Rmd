...
Dataframes can't effectively print list-cols. Tibbles never change type of input e.g. from strings to factors and tibbles never change names of variables, never creates row names. Also, you can do list-cols with tibbles.
