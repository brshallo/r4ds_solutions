...
[^SplineNote]: 
  Below you can see the differences between splines and polynomials as we extrapolate outside of the immediate range of interest. Let's create another dataset with a slightly larger domain
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-1-1.pdf)<!-- --> 
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-2-1.pdf)<!-- --> 
    ...
    *Below are notes on performance of splines vs polynomials when extrapolating data*
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-4-1.pdf)<!-- --> 
    ...
    *Build equivalent models using `poly`*
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-6-1.pdf)<!-- --> 
...
1.  One downside of the linear model is that it is sensitive to unusual values
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-8-1.pdf)<!-- --> 
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-8-2.pdf)<!-- --> 
...
1.  One way to make linear models more robust is to use a different distance
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-11-1.pdf)<!-- --> 
    ...
    * you can see the error for rmse seems to have more extreme examples
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-12-1.pdf)<!-- --> 
    ...
    * let's look at differences in the coefficients produced
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-13-1.pdf)<!-- --> 
    ...
    * another way of visualizing the variability in coefficients is below
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-14-1.pdf)<!-- --> 
...
1.  Instead of using `lm()` to fit a straight line, you can use `loess()`
    ...
    ![](23-model-basics_files/figure-latex/23.3.3 1-1.pdf)<!-- --> 
    ...
    * this relationship looks pretty solidly linear
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-16-1.pdf)<!-- --> 
    ...
    ![](23-model-basics_files/figure-latex/unnamed-chunk-17-1.pdf)<!-- --> 
...
1.  `add_predictions()` is paired with `gather_predictions()` and 
    ...
    * `gather_predictions()` adds 2 columns `model` and `pred` for each model and repeats the input rows for each model (seems like it would work well with facets)
    ...
    ![](23-model-basics_files/figure-latex/23.3.3 2-1.pdf)<!-- --> 
...
![](23-model-basics_files/figure-latex/unnamed-chunk-21-1.pdf)<!-- --> 
...
![](23-model-basics_files/figure-latex/unnamed-chunk-22-1.pdf)<!-- --> 
...
![](23-model-basics_files/figure-latex/unnamed-chunk-23-1.pdf)<!-- --> 
...
![](23-model-basics_files/figure-latex/distance_graph-1.pdf)<!-- --> 
...
![](23-model-basics_files/figure-latex/unnamed-chunk-24-1.pdf)<!-- --> 
...
![](23-model-basics_files/figure-latex/grid search-1.pdf)<!-- --> 
