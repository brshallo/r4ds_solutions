...
##  8  4.31  4.28  2.67  62.2    58  0.30   Premium     D   709     SI1     2
...
1.  *Compute the average delay by destination, then join on the `airports`*
    ...
    *easy way to draw a map of the United States:*  
    ...
    ![](ch_13_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
...
1.  *Add the location of the origin _and_ destination (i.e. the `lat` and `lon`)*
    *to `flights`.*
    ...
    ##  7    507      B6   FLL 26.07258 -80.15275    EWR   40.69250  -74.16867
...
1.  *Is there a relationship between the age of a plane and its delays?*
    ...
    ![](ch_13_files/figure-html/unnamed-chunk-17-1.png)<!-- -->
    ...
    ![](ch_13_files/figure-html/unnamed-chunk-18-1.png)<!-- -->
...
1.  *What weather conditions make it more likely to see a delay?*
    ...
    ![](ch_13_files/figure-html/unnamed-chunk-19-1.png)<!-- -->
...
Create summary of average hourly weather values for worst 48 hour period, for average period, and then append these and plot.
...
![](ch_13_files/figure-html/unnamed-chunk-29-1.png)<!-- -->
    

    I show plots and models of 48 hour time windows in a variety of contexts and detail in [13.5.1.4]
...
##13.5.1.4
    ...
    ![](ch_13_files/figure-html/unnamed-chunk-32-1.png)<!-- -->
    ...
    ![](ch_13_files/figure-html/unnamed-chunk-34-1.png)<!-- -->
   ...
   Connect delays and weather data
    ...
    ![](ch_13_files/figure-html/unnamed-chunk-36-1.png)<!-- -->
    ...
    ![](ch_13_files/figure-html/unnamed-chunk-37-1.png)<!-- -->
...
![](ch_13_files/figure-html/unnamed-chunk-41-1.png)<!-- -->
...
![](ch_13_files/figure-html/unnamed-chunk-42-1.png)<!-- -->
...
## pressure   -0.3500631 -0.25355591 -0.30579095  1.0000000 -0.49709721
...
## precip      198.58855  104.11089   1.907   0.0573 .  
