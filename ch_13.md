...
Ammend weather data so that weather is an average across three NY locations rather than seperate for each [1]
...
2.  *You might expect that there's an implicit relationship between plane* *and airline, because each plane is flown by a single airline. Confirm* *or reject this hypothesis using the tools you've learned above.*
...
--------
    ...
    ![](ch_13_files/figure-markdown_github/unnamed-chunk-33-1.png)
    ...
    ![](ch_13_files/figure-markdown_github/unnamed-chunk-35-1.png)
...
Connect delays and weather data
    ...
    ![](ch_13_files/figure-markdown_github/unnamed-chunk-37-1.png)
...
![](ch_13_files/figure-markdown_github/unnamed-chunk-42-1.png)
