...
-   [Appendix](#appendix)
    ...
    -   [Logs (simulated examples)](#logs-simulated-examples)
        ...
        -   [Log log relationship](#log-log-relationship)
...
![](ch24_files/figure-markdown_github/unnamed-chunk-41-2.png)

``` r
ggplot(diamonds2_w_mod, aes(clarity, resid_lg)) + geom_boxplot()
```

![](ch24_files/figure-markdown_github/unnamed-chunk-41-3.png)
