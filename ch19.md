...
5.  Write `both_na()`, a function that takes two vectors of the same length and returns the number of positions that have an `NA` in both vectors.
    ...
    ```
        ...
        ## Warning in both_na(x, z): Vectors are not equal length
...
-   ctrl + shift + r creates section breaks in R scripts like below `# test label --------------------------------------------------------------`
...
2.  Write a greeting function that says "good morning", "good afternoon", or "good evening", depending on the time of day. (Hint: use a time argument that defaults to `lubridate::now()`. That will make it easier to test your function.)
    ...
    ```
        ...
        ## good evening, it is 2018-04-15 17:50:05
...
What is best practice for replacing long chain of `ifelse` statements in vectorized contexts? For 19.2.1.2 if this were in a dataframe context, what would be the best practice -- typically I would use a bunch of `ifelse` statements, but this does not seem optimal...
