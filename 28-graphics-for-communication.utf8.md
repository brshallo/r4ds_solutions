...
1.  Create one plot on the fuel economy data with customised `title`,
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-1-1.pdf)<!-- --> 
...
1.  The `geom_smooth()` is somewhat misleading because the `hwy` for
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-2-1.pdf)<!-- --> 
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-3-1.pdf)<!-- --> 
...
1.  Use `geom_text()` with infinite positions to place text at the
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-4-1.pdf)<!-- --> 
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-5-1.pdf)<!-- --> 
...
![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-6-1.pdf)<!-- --> 
...
1.  Read the documentation for `annotate()`. How can you use it to add a text
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-7-1.pdf)<!-- --> 
...
1.  How do labels with `geom_text()` interact with faceting? How can you
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-8-1.pdf)<!-- --> 
...
1.  What arguments to `geom_label()` control the appearance of the background
    ...
    * `alpha` controls it's relative brighness
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-9-1.pdf)<!-- --> 
...
1.  What are the four arguments to `arrow()`? How do they work? Create a series
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-10-1.pdf)<!-- --> 
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-11-1.pdf)<!-- --> 
    
    ```r
    b + geom_curve(aes(x = x1, y = y1, xend = x2, yend = y2), data = df, curvature = -0.2)
    ```
    
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-11-2.pdf)<!-- --> 
    
    ```r
    b + geom_curve(aes(x = x1, y = y1, xend = x2, yend = y2), data = df, curvature = 1)
    ```
    
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-11-3.pdf)<!-- --> 
    ...
    ![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-11-4.pdf)<!-- --> 
...
![](28-graphics-for-communication_files/figure-latex/unnamed-chunk-14-1.pdf)<!-- --> 
