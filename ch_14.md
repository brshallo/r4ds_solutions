...
![](ch_14_files/figure-markdown_github/unnamed-chunk-16-1.png)
...
![](ch_14_files/figure-markdown_github/unnamed-chunk-17-1.png)
...
2.  *How would you match the sequence `"'\`?*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-18-1.png)
...
3.  *What patterns will the regular expression `\..\..\..` match? *
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-19-1.png)
...
1.  *How would you match the literal string `"$^$"`?*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-22-1.png)
...
2.  *Given the corpus of common words in `stringr::words`, create regular* *expressions that find all words that:*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-23-1.png)
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-24-1.png)
...
1.  *Create regular expressions to find all words that:*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-28-1.png)
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-29-1.png)
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-30-1.png)
...
2.  *Empirically verify the rule "i before e except after c".*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-31-1.png)
...
3.  *Is "q" always followed by a "u"?*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-32-1.png)
...
4.  *Write a regular expression that matches a word if it's probably written* *in British English, not American English.*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-33-1.png)
...
5.  *Create a regular expression that will match telephone numbers as commonly* *written in your country.*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-34-1.png)
...
![](ch_14_files/figure-markdown_github/unnamed-chunk-35-1.png)

``` r
str_view(x, 'C{2,3}?')
```

![](ch_14_files/figure-markdown_github/unnamed-chunk-35-2.png)
...
2.  *Describe in words what these regular expressions match:* *(read carefully to see if I'm using a regular expression or a string* *that defines a regular expression.)*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-36-1.png)
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-37-1.png)
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-38-1.png)
    ...
    ```
        ...
        ## Warning in sample.int(x, size, replace, prob): '.Random.seed' is not an
        ## integer vector but of type 'NULL', so ignored

    ![](ch_14_files/figure-markdown_github/unnamed-chunk-39-1.png)
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-39-2.png)
...
3.  *Create regular expressions to find all words that:*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-40-1.png)
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-41-1.png)
...
1.  *Describe, in words, what these expressions will match:*
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-43-1.png)

    ``` r
    str_view_all(fruit, "(.)(.)\\2\\1", match = TRUE) #xyyx
    ```

    ![](ch_14_files/figure-markdown_github/unnamed-chunk-43-2.png)

    ``` r
    str_view_all(fruit, "(..)\\1", match = TRUE) #xxyy
    ```

    ![](ch_14_files/figure-markdown_github/unnamed-chunk-43-3.png)

    ``` r
    str_view(stringr::words, "(.).\\1.\\1", match = TRUE) #x.x.x
    ```

    ![](ch_14_files/figure-markdown_github/unnamed-chunk-43-4.png)

    ``` r
    str_view(stringr::words, "(.)(.)(.).*\\3\\2\\1", match = TRUE) #xyz.*zyx
    ```

    ![](ch_14_files/figure-markdown_github/unnamed-chunk-43-5.png)
...
1.  *How would you find all strings containing `\` with `regex()` vs.* *with `fixed()`?* would be `\\` instead of `\\\\`
    ...
    ![](ch_14_files/figure-markdown_github/unnamed-chunk-66-1.png)
