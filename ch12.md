...
-   [ch. 12: Tidy data](#ch.-12-tidy-data)
    -   [12.2: Tidy data](#tidy-data)
        -   [12.2.1.](#section)
    -   [12.3: Spreading and gathering](#spreading-and-gathering)
        -   [12.3.3.](#section-1)
...
`extract` is like `separate` but provide what to capture rather than what to split by as in `sep` instead of `sep`, `sep` default accepts a regex expression, but it allows numeric whereas I'm guessing

``` r
df <- data.frame(x = c("a-b", "a-d", "b-c", "d&e", NA))
...
![](ch12_files/figure-markdown_github/unnamed-chunk-19-1.png)
...
![](ch12_files/figure-markdown_github/unnamed-chunk-19-2.png)
...
![](ch12_files/figure-markdown_github/unnamed-chunk-19-3.png)
...
![](ch12_files/figure-markdown_github/unnamed-chunk-19-4.png)
...
![](ch12_files/figure-markdown_github/unnamed-chunk-19-5.png)
...
![](ch12_files/figure-markdown_github/unnamed-chunk-19-6.png)
